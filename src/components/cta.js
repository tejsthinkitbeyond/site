export const CTA = () => {
  return (
    <div class="bg-black px-10 md:px-20 py-10 md:py-20 mt-20 mx-auto max-w-4xl rounded-lg flex flex-col items-center text-center px-8 mx-10 md:mx-auto md:px-24">
